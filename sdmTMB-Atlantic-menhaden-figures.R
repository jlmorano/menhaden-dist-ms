...
#----- Read in Data & Prep ------------------------------------------------------------
# Full dataset
menhaden <- read.csv("D:/DATA/Atlantic_menhaden_modeling/1-data-input/combined-catch-envtl-20250326.csv", header = TRUE)
...
# on Mac
# Spring
# fit.sp <- readRDS("/Users/janellemorano/DATA/_from CAC redcloud/MODEL_OUTPUT/twar.fit.spring.rds")
# p.sp <- readRDS(file = "/Users/janellemorano/DATA/_from CAC redcloud/MODEL_OUTPUT/twar.predictions.spring.rds")
# pu.sp <- readRDS(file = "/Users/janellemorano/DATA/_from CAC redcloud/MODEL_OUTPUT/predictions-uncertainty-spring-data.rds")
# 
# # Fall
fit.fa <- readRDS("/Users/janellemorano/DATA/_from CAC redcloud/MODEL_OUTPUT/twar.fit.fall.rds")
p.fa <- readRDS(file = "/Users/janellemorano/DATA/_from CAC redcloud/MODEL_OUTPUT/twar.predictions.fall.rds")
pu.fa <- readRDS(file = "/Users/janellemorano/DATA/_from CAC redcloud/MODEL_OUTPUT/predictions-uncertainty-fall-data.rds")
