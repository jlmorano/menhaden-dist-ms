# Figure1BCSupp-TempDepth.R
######################################
# Janelle L. Morano

# Figures for manuscript
# Supplemental Fig 1. Depth vs Temperature
# Figure 1B. Presence vs Temperature
# Figure 1C. Biomass vs Temperature
...
ggplot() +
  geom_histogram(data = data.list[[1]], aes(x = WaterTemp, fill = "Spring"), 
                 color = "#006164", bins = 30, alpha = 0.90) +
  geom_histogram(data = data.list[[2]], aes(x = WaterTemp, fill = "Fall"), 
  ...
  labs(fill = "Season")
#ggsave(file = "/Users/janellemorano/Git/menhaden-dist-ms/figures/Fig1B.presence-v-temp.png", width=6, height = 4)
...
ggplot(data.list[[1]], aes(x=WaterTemp, y=log(Biomass+1))) +
...
#ggsave(file = "/Users/janellemorano/Git/menhaden-dist-ms/figures/Fig1C.biomass-v-temp.png", width=6, height = 4)
